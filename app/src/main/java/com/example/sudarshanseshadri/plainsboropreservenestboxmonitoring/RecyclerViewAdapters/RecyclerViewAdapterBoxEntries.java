...
import com.example.sudarshanseshadri.plainsboropreservenestboxmonitoring.CreateBoxEntryActivity;
...
public class RecyclerViewAdapterBoxEntries extends RecyclerView.Adapter<RecyclerViewAdapterBoxEntries.ViewHolder>{
    ...
    public RecyclerViewAdapterBoxEntries(ArrayList<LogBoxEntry> mBoxEntries, Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        //change layout
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_card_box_entries, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int i) {
        ...
        viewHolder.parentLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(), CreateBoxEntryActivity.class);
        ...
        viewHolder.parentLayout.findViewById(R.id.id_imageView_delete).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mBoxEntries.remove(viewHolder.getAdapterPosition());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        ImageView birdImage, deleteImageButton;
        CardView parentLayout;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            birdImage = itemView.findViewById(R.id.id_imageView_birdImage);
            deleteImageButton = itemView.findViewById(R.id.id_imageView_delete);
            boxNum = itemView.findViewById(R.id.id_textView_boxNumber);
            birdName = itemView.findViewById(R.id.id_textView_birdSpecies);
            parentLayout = itemView.findViewById(R.id.id_card_layout_box_entries);
